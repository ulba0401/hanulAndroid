...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Context context, int layout, ArrayList<UserVO> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ListAdapter.UserprofileViewHolder viewHolder;
        ...
        if (convertView == null){
            ...
            viewHolder = (ListAdapter.UserprofileViewHolder) convertView.getTag();
        }
