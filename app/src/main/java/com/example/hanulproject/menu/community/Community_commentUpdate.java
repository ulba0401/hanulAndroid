...
public class Community_commentUpdate extends AsyncTask<Void,Void,Void> {
    ...
    public Community_commentUpdate(int no, String content, CommunityCommentAdpater adpater){
        this.no = no;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        String postURL = ipConfig + "/AA/cm_cmt_update";
